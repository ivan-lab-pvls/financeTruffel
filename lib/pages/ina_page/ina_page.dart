...
class InaPage extends StatefulWidget {
  const InaPage({super.key});

  @override
  State<InaPage> createState() => _InaPageState();
}

class _InaPageState extends State<InaPage> {
  var _inited = false;
      ...
      body: PageView(
        ...
        children: [
          ...
          SubBoarding(
            ...
            onTap: () async {
              await _sharedPreferences.setBool('isBoardingDone', true);
              context.go(Routes.atHome);
            },
            sec: true,
            child: Image.asset(
